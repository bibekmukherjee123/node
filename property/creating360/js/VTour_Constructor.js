...
function VTour_constructor() {
    ...
    function File_manager() {
        ...
        this.upload_json = function (file_name) {
            ...
            var base_url = "http://propertydarshan.com"
            var filepath = "property/3d_tour/" + file_name + ".json";
            $.ajax({
               url: base_url + "/jsontours/create",
                type: "post",
                data: {
                   "title": file_name,
                    "filePath": filepath
                ...
                success: function(result) {
                   console.log('created was successfully saved to database');
                },
                error: function(err) {
                   console.log('there was error saving the file :' + err);
                }
            });
        ...
        this.dropzone = new Dropzone(dropzone_dom, {
            paramName: "tour",
            url      : "http://propertydarshan.com/vrupload/tourupload",
            success  : function (file, response) {
                ...
                if (response == "success") {
                    ...
                    scope.message_box.show_message("Success: File is saved");
        ...
        // init
        if (!this.dom_element) return;
        this.dom_element.setAttribute("src","Filemanager");
